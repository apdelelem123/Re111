...
async def zed_handler(event):
    ...
    if query.startswith("ريبثون") and event.query.user_id == zq_lo.uid:
        ...
        buttons = [[Button.url("قنـاة السـورس", "https://t.me/rr_r_v"),],[Button.url("التحـديثـات", "https://t.me/rr_r_v_up"), Button.url("الفـارات", "https://t.me/rr_r_v_vars"),],[Button.url("الشـروحـات¹", "https://t.me/rr_r_vn"),],[Button.url("الشـروحـات²", "https://t.me/rr_r_vn"),],[Button.url("مطـور السـورس", "https://t.me/E_7_V"),]]
