...
async def upstream(event):
    ...
    if conf == "الان":
        ...
        await event.edit("𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙍𝙀𝙋𝙏𝙃𝙊𝙉 - تحـديثـات السـورس](t.me/rr_r_v_up) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريبـــثون .. انتظـر . . .🌐𓆰**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙍𝙀𝙋𝙏𝙃𝙊𝙉 - تحـديثـات السـورس](t.me/rr_r_v_up) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريبـــثون .. انتظـر . . .🌐𓆰**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙍𝙀𝙋𝙏𝙃𝙊𝙉 - تحـديثـات السـورس](t.me/rr_r_v_up) 𓆪\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ريبـــثون .. انتظـر . . .🌐𓆰**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
...
async def upstream(event):
    ...
    event = await edit_or_reply(event, f"𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 R𝙀𝙋𝙏𝙃𝙊𝙉𖠏 - تحـديثـات السـورس](t.me/rr_r_v_up) 𓆪\n**•─────────────────•**\n\n**⪼ يتم تنصيب التحديث  انتظر 🌐 𓆰،**")
    off_repo = "
    https://github.com/abdalaleQ/E_7_V"
    os.chdir("/app")
    try:
        txt = (
